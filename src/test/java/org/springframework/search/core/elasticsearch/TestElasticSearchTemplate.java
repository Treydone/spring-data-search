...
public class TestElasticSearchTemplate {
	...
	public void addDocumentAndCheckResult() {
		...
		assertTrue("There are some failures here:" + response.getFailures(), CollectionUtils.isEmpty(response.getFailures()));
	}
	...
	public void addDocumentsAndCheckResult() {
		...
		assertTrue("There are some failures here:" + response1.getFailures(), CollectionUtils.isEmpty(response1.getFailures()));
		...
		assertTrue("There are some failures here:" + response2.getFailures(), CollectionUtils.isEmpty(response2.getFailures()));
	}
